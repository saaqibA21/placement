          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-3 flex-wrap">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-0.5">{user?.branch}</p>
                <p className="text-gray-400 text-xs mt-0.5 font-mono">{user?.rollNo}</p>
              </div>
        ...
        {editing && (
          <div className="mt-5 pt-5 border-t grid grid-cols-1 sm:grid-cols-3 gap-3"
            ...
            {[
              ...
              <div key={key}>
                <label className="text-[10px] font-bold uppercase tracking-wider text-gray-400 flex items-center gap-1 mb-1.5">
                  <Icon size={11} /> {label}
                </label>
        ...
        {resume ? (
          ...
          <div className="flex items-center gap-4 p-4 rounded-xl border" style={{ background: '#EFF5F3', borderColor: '#D9E3E0' }}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-400 mt-0.5">{resume.size} · Uploaded {resume.uploadedOn}</p>
            </div>
