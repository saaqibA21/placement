...
export default function AdminStudents() {
  const { students, toggleStudentFreeze } = useApp();   // ← shared context
  ...
  const placedCount   = students.filter((s) => s.offers > 0).length;
    ...
    <div className="p-4 sm:p-6 max-w-6xl mx-auto space-y-5">
      ...
      <div className="card-solid p-4 bg-white space-y-3" style={{ borderColor: '#EDE0D0' }}>
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-1 bg-gray-100 p-1 rounded-xl border border-gray-200 text-xs font-semibold flex-wrap">
            <span className="px-2 text-gray-400">CGPA:</span>
            ...
            <tbody className="divide-y" style={{ divideColor: '#EDE0D0' }}>
              {filtered.length === 0 ? (
                ...
                <tr key={student.id} className="table-row-light">
                  <td className="px-4 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-[10px] font-mono">{student.email}</p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-4 text-xs text-gray-600 whitespace-nowrap">{student.applied}</td>
                  <td className="px-4 py-4 whitespace-nowrap">
                    {student.offers > 0 ? (
