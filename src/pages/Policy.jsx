...
• Discrepancies between submitted resume and original credentials lead to immediate disqualification.`,
  },
  {
    ...
    body: `• For discrepancies or placement queries, email the Placement Officer at placements@jeppiaaruniversity.ac.in.
  ...
  return (
    <div className="p-4 sm:p-6 max-w-4xl mx-auto space-y-5">
      <div>
        ...
        <p className="text-gray-500 text-xs mt-0.5">Jeppiaar University · Department of Placement & Corporate Relations</p>
      </div>

      <div className="space-y-3">
        {SECTIONS.map((s, idx) => (
          <div key={idx} className="card-solid p-5 bg-white border" style={{ borderColor: 'var(--border)' }}>
            <h2 className="text-sm font-bold text-gray-900 mb-2 flex items-center gap-2" style={{ fontFamily: 'Cinzel,serif' }}>
      ...
      <div className="p-4 rounded-xl border flex items-start gap-3" style={{ background: 'var(--amber-pale)', borderColor: 'var(--amber-border)' }}>
