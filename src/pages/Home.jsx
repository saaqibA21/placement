  ...
  return (
    <div className="p-4 sm:p-6 max-w-5xl mx-auto space-y-5">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, #12122B 0%, #1B1B3D 50%, #262654 100%)',
          borderColor: 'rgba(217, 100, 47, 0.4)',
          boxShadow: '0 10px 25px -5px rgba(18, 18, 43, 0.4), inset 0 0 20px rgba(217, 100, 47, 0.15)',
        }}
      >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Open Drives',   value: openJobs.length,     color: '#1B1B3D', path: '/student/jobs',    icon: Briefcase    },
          { label: 'Applied',       value: appliedJobs.length,  color: '#15803d', path: '/student/jobs',    icon: CheckCircle2 },
          { label: 'Active Rounds', value: activeRounds.length, color: '#D9642F', path: '/student/tracker', icon: Activity     },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="card-solid bg-white overflow-hidden" style={{ borderColor: 'var(--border)' }}>
          <div className="flex items-center justify-between px-5 py-3.5 border-b" style={{ borderColor: 'var(--border)' }}>
            <h2 className="text-sm font-bold text-slate-900" style={{ fontFamily: "'Bebas Neue',sans-serif", letterSpacing:'0.03em' }}>Open Drives</h2>
        ...
        <div className="card-solid bg-white overflow-hidden" style={{ borderColor: 'var(--border)' }}>
          <div className="flex items-center justify-between px-5 py-3.5 border-b" style={{ borderColor: 'var(--border)' }}>
            <h2 className="text-sm font-bold text-slate-900" style={{ fontFamily: "'Bebas Neue',sans-serif", letterSpacing:'0.03em' }}>Recent Circulars</h2>
