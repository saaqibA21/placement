  ...
  return (
    <div className="flex h-full overflow-hidden flex-col md:flex-row">
      ...
      <div className={`flex flex-col overflow-hidden transition-all ${selectedJob ? 'md:w-[55%]' : 'w-full'}`}>
        {/* Page Header */}
        <div className="px-4 sm:px-6 pt-5 pb-4 border-b bg-white" style={{ borderColor: '#D9E3E0' }}>
          <h1 className="text-xl font-bold text-gray-900" style={{fontFamily:"'Bebas Neue',sans-serif", letterSpacing:'0.03em'}}>Campus Recruitment Drives</h1>
          <p className="text-gray-500 text-xs mt-0.5">Browse and apply to all active placement drives</p>
          <div className="flex flex-wrap gap-5 mt-4">
            {[
              { label: 'Total', value: totalCount, color: '#D9642F' },
        ...
        {/* Search + Sort */}
        <div className="px-4 sm:px-6 py-3 bg-white border-b flex flex-wrap items-center gap-3" style={{ borderColor: '#D9E3E0' }}>
        ...
        {/* Tab Filter */}
        <div className="px-4 sm:px-6 py-2 bg-white border-b flex gap-1 overflow-x-auto" style={{ borderColor: '#D9E3E0' }}>
          {TABS.map((t) => (
        ...
        {/* Jobs List */}
        <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-4 space-y-3" style={{ background: '#EFF5F3' }}>
          {filtered.length === 0 ? (
            ...
            filtered.map((job) => (
              <div key={job.id} onClick={() => { setSelected(job); setDrawerTab('overview'); }}
                ...
                style={{
                  borderColor: selectedJob?.id === job.id ? '#D9642F' : undefined,
      ...
      {/* Detail Drawer */}
      {selectedJob && (
        <div className="flex-1 flex flex-col border-t md:border-t-0 md:border-l overflow-hidden bg-white" style={{ borderColor: '#D9E3E0' }}>
          <div className="px-5 py-4 border-b flex items-start justify-between gap-3" style={{ borderColor: '#D9E3E0', background: '#EFF5F3' }}>
          ...
          <div className="flex gap-1 px-5 py-2 border-b" style={{ borderColor: '#D9E3E0' }}>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={item.label} className="p-3 rounded-xl border" style={{ background: '#EFF5F3', borderColor: '#D9E3E0' }}>
                ...
                {(selectedJob.applyBefore || selectedJob.dateOfVisit) && (
                  <div className="p-3 rounded-xl border space-y-2" style={{ background: '#EFF5F3', borderColor: '#D9E3E0' }}>
                  ...
                  <div className="space-y-2.5">
                    {['Application Screening', 'Online Assessment / Aptitude Test', 'Technical Interview', 'HR Interview', 'Offer Rollout'].map((r, i) => (
                      <div key={r} className="flex items-center gap-3">
                        <div className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold text-white flex-shrink-0" style={{ background: '#D9642F' }}>{i + 1}</div>
          ...
          <div className="px-5 py-4 border-t" style={{ borderColor: '#D9E3E0' }}>
            {selectedJob.applied ? (
